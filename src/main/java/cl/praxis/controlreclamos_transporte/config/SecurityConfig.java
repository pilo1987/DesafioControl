...
import cl.praxis.controlreclamos_transporte.service.UsuarioDetailsServiceImpl;
...
public class SecurityConfig {
    ...
    @Bean
    public AuthenticationProvider authenticationProvider(UsuarioDetailsServiceImpl userDetailService){
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((authz) -> authz
                        ...
                        .requestMatchers(HttpMethod.GET,"/control/**").permitAll()
                        .requestMatchers("/users/**").hasAnyRole("USER", "ADMIN")
                        .requestMatchers("/roles/**").hasAnyRole("ADMIN")
                        .anyRequest().denyAll()
                ).formLogin((form) -> form
                        .loginPage("/login")
                        .defaultSuccessUrl("/control/login", true)
